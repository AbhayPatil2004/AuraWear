    ...
    const toggleBlock = async (user) => {
        try {
            ...
            const endpoint = user.isBlocked
                ? `${process.env.NEXT_PUBLIC_API_URL}/admin/users/unban/${user._id}`
                : `${process.env.NEXT_PUBLIC_API_URL}/admin/users/ban/${user._id}`;
                                ...
                                <tr key={user._id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 flex justify-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-md text-sm text-white ${user.isBlocked
